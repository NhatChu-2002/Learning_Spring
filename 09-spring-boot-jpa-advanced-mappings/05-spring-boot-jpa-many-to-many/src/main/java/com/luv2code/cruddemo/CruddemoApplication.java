...
//			deleteCourse(appDAO);
	...
	private void deleteStudent(AppDAO appDAO) {
		...
		System.out.println("Delete the student id: " + theId);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		System.out.println("the associated course: " + tempStudent.getCourses());
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		Course tempCourse = new Course("Pacman the game");

		Student tempStudent1 = new Student("John","Doe", "luv2code.email" );
		Student tempStudent2 = new Student("Susan","Park", "luv2code.email2" );
		Student tempStudent3 = new Student("Nick","Jonas", "luv2code.email3" );
